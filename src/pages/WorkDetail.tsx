...
const worksData: Record<string, WorkProjectData> = {
  "driveway-patio-power-wash": {
    ...
    description: "Deep power washing of extensive commercial entrance paving and forecourt in Ennis, Co. Clare.",
    detailTitle: "Complete Commercial Paving Restoration",
    detailDescription:
      "The commercial property had accumulated over five years of heavy moss, black lichen, and slippery green algae across a 250m² brick-paved entrance and customer forecourt. The client needed a complete restoration without damaging the joint sand or stone surfaces.",
    overview: [
      ...
      "Precision border and edge detailing around landscaped grounds",
    ...
    workSteps: [
      ...
      { number: "03", title: "Rinse Down", description: "Low-pressure perimeter rinse protecting landscaped perimeters and exterior walls." },
      { number: "04", title: "Dry & Re-Sand", description: "Kiln-dried sand brushed into joints to reinforce paving structure." },
    ],
    problems: [
      "Severe slippery algae creating a slip hazard for staff and visitors.",
      "Black lichen ingrained deep into natural stone pores.",
      "Weed growth between pavers destabilizing the entrance walkway border.",
    ],
    solutions: [
  ...
  "residential-move-in-clean": {
    ...
    description: "Top-to-bottom commercial move-in deep clean in Newmarket-on-Fergus.",
    detailTitle: "Turnkey Presentation for Commercial Premises",
    detailDescription:
      "A business moving into a newly acquired commercial premises in Newmarket-on-Fergus booked Force Services for a full deep sanitization. We tackled heavy limescale in staff washrooms, built-up kitchen grease, and complete facility sanitization.",
    overview: [
      "Deep commercial kitchen, hob, extractor fan, and refrigerator degreasing",
      "Intensive washroom descaling, grout scrub, and fixture sterilization",
      "Inside-and-out cleaning of all storage units, cupboards, and presses",
      "Skirting boards, architraves, window sills, and radiators washed",
    ],
    client: "Commercial Business Client",
    ...
    workSteps: [
      ...
      { number: "02", title: "Kitchen & Washrooms", description: "Deep cleaning breakrooms, descaling washrooms and sanitizing toilets." },
      { number: "03", title: "Workspaces & Common Areas", description: "High-to-low dusting, vacuuming, and hard floor steam scrubbing." },
      { number: "04", title: "Welcome Walkthrough", description: "Final client check leaving the premises fresh and ready for operations." },
    ],
    problems: [
      "Heavy limescale buildup on washroom glass and tile grouting.",
      "Burnt-on carbon deposits inside the staff kitchen oven and extractor.",
      "Opening scheduled for the following morning.",
    ],
    solutions: [
      "Commercial descaling agents restoring sparkling clear washroom screens.",
